  ...
  return (
    <div className={`fixed inset-0 z-[100] bg-background/95 backdrop-blur-xl flex flex-col items-center justify-center p-4 transition-opacity duration-500 ${animate ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="mb-10 text-center animate-slide-up">
        ...
        <p className="text-text-light text-sm">Enter PIN to access your finances</p>
      </div>
      
      {/* PIN Dots */}
      <div className={`flex gap-6 mb-12 transition-transform duration-200 ${error ? 'translate-x-[-10px] animate-[shake_0.3s_ease-in-out_infinite]' : ''}`}>
        {[0, 1, 2, 3].map(i => (
